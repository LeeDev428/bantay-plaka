The project follows a modular monolithic architecture, where backend, frontend, and role-based modules are organized into separate folders for better structure, maintainability, and clarity.
